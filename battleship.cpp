...
std::cout << "Sonar detects UP DOWN LEFT RIGHT from the location you chose"<<std::endl;
}
...
std::cout << "YOU HAVE 14 TRIES TO TRACK DOWN AND ELIMINATE ENEMY SHIPS "<<std::endl;
std::cout << std::endl;
for(int i = 0; i <14;i++ ){
  int locator;
  ...
  if (locator>31){
    //put here to clear terminal for easier game tracking
    system("clear");
